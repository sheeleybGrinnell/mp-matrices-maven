...
public class AssociativeArray<K, V> {
   ...
   *
   * @param key
   *   The key to check the array for.
   *
   * @return
   *   True if the key is in the array, false in any other case.
   */
   ...
   *
   * @return
   *   The size of our associative array.
   */
  public int size() {
    return this.size;
  } // size()
   ...
   *
   * @return
   *  The index of the key that we have found.
   */
